...
class MSResNet(torch.nn.Module):
    def __init__(self, input_dim=13, layers=[1, 1, 1, 1], num_classes=9, hidden_dims=32, dropout=0.2):
        self.modelname = f"MSResNet_input-dim={input_dim}_num-classes={num_classes}_hidden-dims={hidden_dims}_dropout={dropout}"
    ...
    def forward(self, x0):
        ...
        # logprobabilities = nn.functional.log_softmax(logits, dim=-1)
